function varargout = modelo4(varargin)
% modelo4 M-file for modelo4.fig
%      modelo4, by itself, creates a new modelo4 or raises the existing
%      singleton*.
%
%      H = modelo4 returns the handle to a new modelo4 or the handle to
%      the existing singleton*.
%
%      modelo4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in modelo4.M with the given input arguments.
%
%      modelo4('Property','Value',...) creates a new modelo4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before modelo4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to modelo4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help modelo4

% Last Modified by GUIDE v2.5 08-Oct-2012 23:57:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @modelo4_OpeningFcn, ...
                   'gui_OutputFcn',  @modelo4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before modelo4 is made visible.
function modelo4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to modelo4 (see VARARGIN)

% Choose default command line output for modelo4
...
% UIWAIT makes modelo4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = modelo4_OutputFcn(hObject, eventdata, handles) 
...
thalfactore= 5;  %multiplicative factor to adjust the inputs
thalfactori= 2;  %multiplicative factor to adjust the inputs
...
[a,b,c,d,loc_inhib, loc_exc]=setabcd(Ne,Ni,type,te,ti);  %set the parameter for izhikievich model
...
tau2=0.5; %for fast integration set tau2=0.5, tau= 1 and set away the comment on v=v+tau2*tau*(0.04*v.^2+4.1*v+108-u+I); 
global t;
for t=1:length(tspan) % simulation of T ms
    
    S=cfactor*wsynap*[excf*MExterna(:,(loc_exc)), inhf*MExterna(:,(loc_inhib))];
    signal_w=str2num(get(handles.edit19,'String')); 
    signal_l=str2num(get(handles.edit20,'String')); 
    modeInput=get(handles.listbox1,'Value');
    I= setInput(Ne,Ni,thalinput, thalfactore, thalfactori, loc_exc, loc_inhib, signal_w, signal_l, modeInput );
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
SimSpikes=evalin('base','SimSpikes');
SimSpikesT=evalin('base','SimSpikesT');
MSimSpikes=evalin('base','MSimSpikes');
MSimSpikesT=evalin('base','MSimSpikesT');
