...
% Last Modified by GUIDE v2.5 10-Jan-2013 21:44:42
...
%     signal_l=str2num(get(handles.edit20,'String')); %level of input signal
    ...
    ti= get(handles.listbox5,'Value'); %type of inhibitory neuron   22
    type= get(handles.checkbox2,'Value');
    [a,b,c,d]=setabcd_adapt(Ne,Ni,type,te,ti,loc_inhib,loc_exc);  %set the parameter for izhikievich model. Returns the parameters 
    % for all neurons  
