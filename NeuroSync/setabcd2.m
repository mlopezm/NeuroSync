function [a,b,c,d,loc_inhib,loc_exc]=setabcd(Ne,Ni,type,te,ti)
...
a=randperm(Ne+Ni);
loc_inhib=a(1,1:Ni); %where the inhibitory neurons will be located
loc_exc=a(1,Ni+1:Ni+Ne); %where the excitatory neurons will be located
