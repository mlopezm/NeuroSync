...
% Last Modified by GUIDE v2.5 30-Jan-2013 16:18:53
...
[a,b,c,d,loc_inhib, loc_exc]=setabcd2(Ne,Ni,type,te,ti);  %set the parameter for izhikievich model. Returns the parameters 
...
for t=1:length(tspan) % simulation of T ms
    excf= str2num(get(handles.edit23,'String'));  % factor for excitatory synapsis
    inhf= str2num(get(handles.edit24,'String'));  % factor for inhibitory synapsis
    cfactor=100/(Ne*excf+Ni*inhf); %correction factor to generate an input signal of as much as 100 at any neuron
    
    S=ones(size(MExterna));
    S((loc_exc),:)=cfactor*wsynap*excf*MExterna((loc_exc),:);
    S((loc_inhib),:)=cfactor*wsynap*inhf*MExterna((loc_inhib),:);
...
%     signal_l=str2num(get(handles.edit20,'String')); %level of input signal
    ...
    ti= get(handles.listbox5,'Value'); %type of inhibitory neuron   22
    type= get(handles.checkbox2,'Value');
    [a,b,c,d]=setabcd_adapt2(Ne,Ni,type,te,ti,loc_inhib,loc_exc);  %set the parameter for izhikievich model. Returns the parameters 
    % for all neurons  
...
%     meanfire(t)=length(fired)/(Ne+Ni); % mean number of neurons firings
    ...
    meanfire(t)=length(fired)/(Ne+Ni); % mean number of neurons firings
    inthal(t)=thalinput; % input thalamus slider input
    synw(t)=wsynap;  % synaptic weigth slider input
...
save .\files\VV.mat VV;
save .\files\Spikes.mat Spikes;
assignin('base','MExterna',MExterna);
save .\files\MExterna.mat MExterna;
...
Distanceapp; %call Distance app window
...
% --------------------------------------------------------------------
function n_eigen_Callback(hObject, eventdata, handles)
% hObject    handle to n_eigen (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function hi_app_Callback(hObject, eventdata, handles)
% hObject    handle to hi_app (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Hilbertapp;
...
% --------------------------------------------------------------------
function divergence_m_Callback(hObject, eventdata, handles)
% hObject    handle to divergence_m (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function di_app_Callback(hObject, eventdata, handles)
% hObject    handle to di_app (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Divergenceapp;
